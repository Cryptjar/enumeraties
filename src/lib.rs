...
// The public front-end macro (idk about how to cfg the lazy branches in this approach)
/// Adding a property to an enum
///
...
// The interal marco impl, used by `props`
#[doc(hidden)]
#[macro_export]
macro_rules! props_internal_impl {
    (
    ...
    (
        ...
        // sourounding function return different references (i.e. different
        // addresses) because const gets inlined.
        //
        // If this suddle difference is important, it is concivable to present
